...
const generateProductRepurchaseInvoice = async (invoiceData, filePath) => {
  ...
  const docDefinition = {
    ...
    content: [
      ...
      { text: "Repurchase Tax Invoice", style: "header" },
...
module.exports = { generateProductRepurchaseInvoice };
